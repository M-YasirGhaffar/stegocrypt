...
SECRET_KEY = 'django-insecure-wx8_mku=uk#$q!e48!b!k87g$=mjazn1%iyogkpq)d8h*&!+%w'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'theme' / 'templates',  # theme app
            BASE_DIR / 'core' / 'templates',   # core app
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
